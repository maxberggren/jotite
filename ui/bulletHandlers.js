...
var BulletHandlers = class BulletHandlers {
    ...
    _handleTab(lineText, lines, currentLineNum, lineStartOffset, lineEndOffset, iter) {
        ...
        if (hasSelection) {
            ...
            return this._indentSingleLine(lineText, lineStartOffset, lineEndOffset);
        }
    }
    ...
    _indentSingleLine(lineText, lineStartOffset, lineEndOffset) {
        const bulletMatch = lineText.match(/^(\s*)([-*])(\s*.*)$/);
        if (bulletMatch) {
    ...
    _handleShiftTab(lineText, lines, currentLineNum, lineStartOffset, lineEndOffset, iter) {
        ...
        if (hasSelection) {
            ...
            return this._outdentSingleLine(lineText, lineStartOffset, lineEndOffset);
        }
    }
    ...
    _outdentSingleLine(lineText, lineStartOffset, lineEndOffset) {
        const bulletMatch = lineText.match(/^(\s+)([-*])(\s*.*)$/);
        if (bulletMatch) {
